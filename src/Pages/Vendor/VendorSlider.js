...
import { createvendorsliderApi, deletevendorsliderApi, getVendorCategoriesApi, getvendorSliderApi, updatevendorsliderApi } from "../../services/allApi";
...
function VendorSlider() {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      // Send API request
      const response = await createvendorsliderApi(formData);
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      const response = await deletevendorsliderApi(selectedId);
