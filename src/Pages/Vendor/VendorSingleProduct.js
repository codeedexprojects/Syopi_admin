...
import { deletevendorProductapi, deletevendorProductImageApi, deletevendorproductvariant, getAllVendorBrandsApi, getVendorCategoriesApi, getvendorproductByID, getvendorsubcategoryByID, updatevendorproductapi } from "../../services/allApi";
...
const [deleteImageModal, setDeleteImageModal] = useState({
  ...
  try {
    const response = await deletevendorproductvariant(productId, variantId, {});
    
    if (response.success) {
      toast.success("Variant deleted successfully!");
      // Refresh the product data
      const updatedProduct = await getvendorproductByID(id);
