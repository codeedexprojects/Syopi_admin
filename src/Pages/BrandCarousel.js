...
import { createBrandsliderApi, deleteBrandsliderApi, getAllBrandsApi, getBrandSliderApi, updateBrandsliderApi } from "../services/allApi";
...
function BrandCarousel() {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      // Send API request
      const response = await createBrandsliderApi(formData);
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      const response = await deleteBrandsliderApi(selectedId);
  ...
  return (
    <div className="carousel">
      <Row className="d-flex justify-content-between">
        <Col md={7}>
          <p className="Product-heading">Brand carousel slider</p>
        </Col>
                    ...
                    <Form.Group>
                      ...
                      <div className="dropdown-wrapper">
                        ...
                        >
                          ...
                          {Brands.map((brands) => (
                            <option key={brands._id} value={brands._id}>
                              {brands.name}
                            </option>
                          ))}
                        </Form.Control>
