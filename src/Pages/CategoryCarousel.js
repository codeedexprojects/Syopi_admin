...
import {
  createCategorysliderApi,
  deleteCategorysliderApi,
  getCategoriesApi,
  getCategorySliderApi,
  getsubcategoryByID,
  updateCategorysliderApi,
...
function Carousel() {
  ...
  const [selectedsubCategories, setSelectedsubCategories] = useState(""); // Subcategory ID
  ...
  const handleCategoryChange = (e) => {
    ...
    setSelectedCategories(selectedCatId);
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      // Send API request
      const response = await createCategorysliderApi(formData);
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      const response = await deleteCategorysliderApi(selectedId);
  ...
  return (
    <div className="carousel">
      <Row className="d-flex justify-content-between">
        <Col md={7}>
          <p className="Product-heading">Category carousel slider</p>
        </Col>
                    ...
                    <Form.Group>
                      ...
                      <div className="dropdown-wrapper">
                        <Form.Control
                          className="single-product-form custom-dropdown"
                          as="select"
                          value={selectedsubCategories} // assuming `selected` holds the subcategory ID
