            ...
            <Col md={9} className='single-product-right-column'>
              <Form>
                <Row className="mb-3">
                  <Col md={6}>
                    <Form.Group>
                      <Form.Label className='single-product-form-label'>Name</Form.Label>
                ...
                <Col md={6}>
                  ...
                  <Col md={6}>
                  <Form.Group>
                      <Form.Label className='single-product-form-label'>Gender</Form.Label>
                      <Form.Control className='single-product-form'  type="text" placeholder="Male" />
                    </Form.Group>
                ...
                <Col md={12}>
                    <Form.Group>
                      <Form.Label className='single-product-form-label'>Delivery Address</Form.Label>
