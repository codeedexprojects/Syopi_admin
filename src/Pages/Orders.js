...
function Orders() {
    ...
    const handleSaveClick = (id) => {
      // Add save logic here, e.g., sending the updated status to the server
      setEditRowId(null);
    };
          ...
          <Table  aria-label="simple table">
            <TableHead>
              <TableRow>
                ...
                <TableCell className='dproduct-tablehead' align="left">Customer Name</TableCell>
                ...
                <TableCell className='dproduct-tablehead' align="left">Action</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
        {rows.map((row) => (
          <TableRow key={row.name}>
            ...
            <TableCell align="left" className="dorder-tabledata">4</TableCell>
            <TableCell align="left" className="dorder-tabledata">john</TableCell>
            ...
            <TableCell align="left" className="dorder-tabledata">
              {editRowId === row.name ? (
                <p className='order-save' onClick={() => handleSaveClick(row.name)}>Save</p>
              ) : (
                <p className='order-edit' onClick={() => handleEditClick(row.name)}>Edit</p>
              )}
            </TableCell>
          </TableRow>
        ))}
