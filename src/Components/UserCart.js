    ...
    <div className="user-cart-container">
      <div className="user-cart-header">
        <div>
          ...
          <span className="user-cart-id">
            Cart ID: {cart._id.substring(cart._id.length - 8)}
          </span>
        </div>
      ...
      <div className="user-cart-content">
        <div className="user-cart-items">
          <div className="user-cart-items-header">
            ...
            <span className="user-cart-items-count">{cart.items.length}</span>
          </div>
            ...
            cart.items.map((item) => (
              <div key={item._id} className="user-cart-item">
                <div className="user-cart-item-image-container">
                  <img
                    src={`${BASE_URL}/uploads/${item.productId.variants?.[0]?.images?.[0]}`}
